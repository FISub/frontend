      ...
      <table className="common-table min-w-full bg-white border border-gray-300">
        <thead className="common-thead">
          <tr className="common-tr bg-gray-100">
            ...
            <th className="common-th py-2 px-4 border-b">상품명</th>
            <th className="common-th py-2 px-4 border-b">구독일</th>
            <th className="common-th py-2 px-4 border-b">구독주기</th>
            <th className="common-th py-2 px-4 border-b">배송출발예정일</th>
            <th className="common-th py-2 px-4 border-b">구독횟수</th>
            <th className="common-th py-2 px-4 border-b">상태</th>
            <th className="common-th py-2 px-4 border-b">삭제</th>
          </tr>
        </thead>
        <tbody className="common-tbody">
          {subscriptions.map((subscription) => (
            <tr key={subscription.subNum} className="common-tr">
